...
<div class="app-layout">
    ...
    <aside class="side-nav">
        <a href="other_staff.php" class="nav-link-item active">
...
<!-- Main Content -->
    <main class="main-content">
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
                ...
                <div class="dashboard-card h-100 border-accent-indigo">
                    ...
                    <div class="card-body-custom">
                        <?php if ($recentStatus): ?>
                            ...
                            <a href="request_leaveOS.php" class="btn btn-gradient-indigo">My Requests</a>
                        <?php else: ?>
                ...
                <div class="dashboard-card h-100 <?= $unreadCount > 0 ? 'border-accent-gold' : 'border-accent-teal' ?>">
                    ...
                    <div class="card-body-custom">
                        <?php if ($unreadCount > 0): ?>
                            ...
                            <a href="messagesOS.php" class="btn btn-gradient-gold">Read Messages</a>
                        <?php else: ?>
            ...
            <!-- Pending Role Issues Card -->
            <div class="col">
                <div class="dashboard-card h-100 <?= $pendingCount > 0 ? 'border-accent-rose' : 'border-accent-teal' ?>">
                    <div class="card-header-custom">
                        <i class="fas fa-exclamation-circle" style="color: <?= $pendingCount > 0 ? '#e11d48' : '#0d9488' ?>"></i>
                        <span>Pending Role Issues</span>
                    </div>
                    <div class="card-body-custom">
                        <?php if ($pendingCount > 0): ?>
                            <h5 class="card-title" style="color: #e11d48; font-weight: 700;"><?= $pendingCount; ?> Pending</h5>
                            <p class="card-text text-muted mb-3">Issues matching your role awaiting your attention.</p>
                            <a href="issuesOss.php" class="btn btn-gradient-rose">Attend Issues</a>
                        <?php else: ?>
                            <h5 class="card-title" style="color: #0d9488; font-weight: 700;"><i class="fas fa-check-circle"></i> All Clear</h5>
                            <p class="card-text text-muted mb-3">No pending issues for your role.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="dashboard-card h-100 <?= $recentIssue ? 'border-accent-slate' : 'border-accent-teal' ?>">
                    ...
                    <div class="card-body-custom">
                        <?php if ($recentIssue): ?>
                            ...
                            <a href="issuesOss.php" class="btn btn-gradient-slate mt-2">View Issues</a>
                        <?php else: ?>
