...
<div class="row">
  <div class="col-sm-3 pt-2 bg-light text-center">EPMS<span style='font-size:20px;'>&#128202;</span></div>
  <div class="col-sm-6 pt-2 bg-light text-center">Issues</div>
  <div class="col-sm-3 pt-2 bg-light text-center">
    <?php
...
<div class="report-issue text-center">
  ...
  <button onclick="document.location='issue.php'" class="btn btn-secondary">Click here to report an issue</button>
