...
<div class="app-layout">
    ...
    <aside class="side-nav">
        <a href="other_staff.php"       class="nav-link-item"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a>
        <a href="other_staffProfile.php" class="nav-link-item"><i class="fas fa-user-circle"></i><span>User Profile</span></a>
        <a href="messagesOS.php"         class="nav-link-item"><i class="fas fa-envelope"></i><span>Messages</span></a>
        <a href="request_leaveOS.php"    class="nav-link-item"><i class="fas fa-calendar-check"></i><span>Leave</span></a>
        <a href="feedback.php" class="nav-link-item">
            <i class="fas fa-comment"></i>
            <span>Feedback</span>
        </a>
        <a href="issuesOss.php"           class="nav-link-item active"><i class="fas fa-exclamation-triangle"></i><span>Issues</span></a>
        <a href="Page.html"  class="nav-link-item"><i class="fas fa-building"></i><span>Company Page</span></a>
        <a href="logOut.php"             class="nav-link-item logout"><i class="fas fa-sign-out-alt"></i><span>Log Out</span></a>
    </aside>
