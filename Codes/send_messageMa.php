...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare an SQL statement to insert the message into the messages table
...
<div class="app-layout">
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <a href="messagesMa.php" class="btn btn-gradient-slate">
        ...
        <div class="dashboard-card border-accent-teal">
            ...
            <div class="card-body-custom">
                <form method="POST" action="send_messageMa.php" enctype="multipart/form-data" class="compose-form">
