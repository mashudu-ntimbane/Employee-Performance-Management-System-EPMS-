...
<div class="app-layout">
    ...
    <aside class="side-nav">
        ...
        <a href="issuesHr.php" class="nav-link-item">
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <a href="messagesHR.php" class="btn btn-gradient-slate">
        ...
        <div class="dashboard-card border-accent-teal">
            ...
            <div class="card-body-custom">
                <form method="POST" action="send_messageHR.php" enctype="multipart/form-data" class="compose-form">
